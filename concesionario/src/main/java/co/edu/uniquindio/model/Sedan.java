...
public class Sedan extends Vehiculo implements IElectrico {
    ...
    public Sedan(String marca, String estado, String modelo, int cambios, int velocidadMax, int cilindraje,
            int pasajeros, int puertas, double maletero, boolean aire, boolean camara, boolean crucero, int bolsas,
            boolean abs, boolean sensoresColision, boolean sensoresTrafico, boolean asistente) {
